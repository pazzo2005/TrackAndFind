...
public class archivedEntity {
    ...
    public archivedEntity(String packageId, String expectedTruckId, String currentStatus, LocalDateTime dispatchedAt, String workerNotes) {
